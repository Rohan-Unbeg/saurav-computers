            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                >
                    <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-4 text-white drop-shadow-xl">
                        {t("Our Courses", "आमचे अभ्यासक्रम")}
                    </h1>
                    <p className="text-base md:text-lg text-gray-200 max-w-2xl mx-auto font-medium drop-shadow">
                        {t(
                            "Comprehensive computer education and skill development programs to enhance your career prospects.",
                            "तुमच्या करिअरच्या संधी वाढवण्यासाठी संगणक शिक्षण आणि कौशल्य विकास कार्यक्रम."
                        )}
                    </p>
                </motion.div>
            </div>
